...
TEST(Ais123Test, Decode1Utc) {
  ...
  Validate(
      ...
      -8.6611999999999991, 35.690633333333331, 85, 59, false, 0, false);
...
TEST(Ais123Test, Decode1SlotNumber) {
  ...
  Validate(
      ...
      0, 118.28757833333333, 24.416608333333333, 511, 55, false, 0, false);
...
TEST(Ais123Test, Decode2Rot0) {
  ...
  Validate(
      ...
      51.344011666666667, 258, 2, false, 0, true);
...
TEST(Ais123Test, Decode2Turning) {
  ...
  Validate(
      ...
      0, 41.947201666666665, -62.606396666666669, 114, 27, true, 1, false);
...
TEST(Ais123Test, Decode3) {
  ...
  Validate(
      ...
      41.284183333333331, 158, 55, false, 0, false);
...
TEST(Ais123Test, Decode3KeepTrue) {
  ...
  Validate(
      ...
      0, -74.054433333333336, 40.64525, 2, 59, false, 0, false);
...
TEST(Ais123Test, Decode3Special) {
  ...
  Validate(
      ...
      4.4132, 51.886163333333336, 511, 0, true, 0, true);
