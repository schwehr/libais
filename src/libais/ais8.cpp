...
Ais8_200_23::Ais8_200_23(const char *nmea_payload, const size_t pad)
  ...
  bs.SeekTo(56);
  utc_year_start = bs.ToUnsignedInt(56, 9);
  utc_month_start = bs.ToUnsignedInt(65, 4);
  // ERROR: not enough bits to cover 1-31.
  utc_day_start = bs.ToUnsignedInt(69, 4);
  utc_year_end = bs.ToUnsignedInt(73, 9);
  utc_month_end = bs.ToUnsignedInt(82, 4);
  // ERROR: not enough bits to cover 1-31.
  utc_day_end = bs.ToUnsignedInt(86, 4);
