...
class DecodeTagBlockTest(TagTestCase):
  ...
  def testSingleLineMessage(self):
    ...
    line = (
        r'\n:852057,s:b003669955,c:1428451729*1B'
        r'\!ABVDM,1,1,,A,K8VSqb9LdU28WP8p,0*49'
    )
  ...
  def testManySingleLineMessages(self):
    lines = (
        # pylint: disable=line-too-long
        r'\s:rORBCOMM000,q:u,c:1426032001,T:2015-03-11 00.00.01*58\!AIVDM,1,1,,B,19NWuDP0006D=1B<qOuGg6<00000,0*34',
        r'\s:rORBCOMM000,q:u,c:1426032499,T:2015-03-11 00.08.19*5c\!AIVDM,1,1,,A,232S8G0P01Q;WaHKSmBH;OvN0H9T,0*6A',
        r'\s:rORBCOMM000,q:u,c:1426032001,T:2015-03-11 00.00.01*58\!AIVDM,1,1,,B,38v6Cl5000QDF;MdVMFLC9ol2Dcr,0*0A',
        ...
        r'\s:rORBCOMM000,q:u,c:1426032579,T:2015-03-11 00.09.39*50\!AIVDM,1,1,,A,H3n6rc4TCBD5PRV<7@2000203330,0*18',
        # 25 I
    ...
    for msg_num, msg in enumerate(msgs):
