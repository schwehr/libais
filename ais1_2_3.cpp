...
Ais1_2_3::Ais1_2_3(const char *nmea_payload, const size_t pad)
    : AisMsg(nmea_payload, pad), nav_status(0), rot_over_range(false),
      ...
      raim(false), sync_state(0), slot_timeout(0), slot_timeout_valid(false),
      received_stations(0), received_stations_valid(false), slot_number(0),
      slot_number_valid(false), utc_valid(false), utc_hour(0), utc_min(0),
      utc_spare(0), slot_offset(0), slot_offset_valid(false), slot_increment(0),
      slot_increment_valid(false), slots_to_allocate(0),
